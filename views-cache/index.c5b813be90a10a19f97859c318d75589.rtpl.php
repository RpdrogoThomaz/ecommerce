<?php if(!class_exists('Rain\Tpl')){exit;}?> <div class="slider-area">
        	<!-- Slider -->
			<div class="block-slider block-slider4" align="middle">
				<ul class="" id="bxslider-home4">
					<li>
						<img src="/res/site/img/h4-slide.png" alt="Slide" style="width:860px; height:362px;">
					...
					<li><img src="/res/site/img/h4-slide2.png" alt="Slide" style="width:860px; height:362px;">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="/res/site/img/h4-slide3.png" alt="Slide" style="width:860px; height:362px;">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="/res/site/img/h4-slide4.png" alt="Slide" style="width:860px; height:362px;">
						<div class="caption-group">
							<h2 class="caption title">
								Carter's <span class="primary">Store <strong>Bodysuits</strong></span>
							</h2>
							<h4 class="caption subtitle">Select Item</h4>
							<a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
						</div>
